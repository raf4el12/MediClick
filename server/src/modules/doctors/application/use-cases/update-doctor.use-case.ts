...
export class UpdateDoctorUseCase {
  ...
  async execute(
    ...
    // Staff cannot reassign doctor to a different clinic
    if (clinicId && dto.clinicId !== undefined && dto.clinicId !== clinicId) {
      throw new ForbiddenException('No puede reasignar un doctor a otra sede');
    }
    ...
    if (
      ...
      dto.maxOverbookPerDay !== undefined ||
      ...
      updateData.doctor = {
        ...
        ...(dto.maxOverbookPerDay !== undefined && {
          maxOverbookPerDay: dto.maxOverbookPerDay,
        }),
