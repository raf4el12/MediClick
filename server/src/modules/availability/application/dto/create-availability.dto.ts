...
export class CreateAvailabilityDto {
  ...
  @ApiProperty({
    example: 1,
    description: 'ID de la especialidad asignada al doctor',
  })
  @Type(() => Number)
  @IsInt()
  ...
  @ApiProperty({
    example: '2026-03-01',
    description: 'Fecha inicio de vigencia (YYYY-MM-DD)',
  })
  ...
  @ApiProperty({
    example: '2026-12-31',
    description: 'Fecha fin de vigencia (YYYY-MM-DD)',
  })
  ...
  @ApiProperty({
    ...
    description: 'Tipo de disponibilidad',
  })
  @IsEnum(AvailabilityType, {
    message: 'type debe ser REGULAR, EXCEPTION o EXTRA',
  })
  @IsNotEmpty({ message: 'El tipo es obligatorio' })
  type: AvailabilityType;

  @ApiPropertyOptional({
    example: 'Horario de consultorio principal',
    description: 'Razón o nota',
  })
  @IsString()
  @IsOptional()
  reason?: string;
