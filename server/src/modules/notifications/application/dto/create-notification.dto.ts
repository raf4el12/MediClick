...
export class CreateNotificationDto {
    ...
    @ApiProperty({ example: 'Cita confirmada', description: 'Título de la notificación' })
    @IsString()
    @IsNotEmpty({ message: 'El título es obligatorio' })
    title: string;

    @ApiProperty({
        example: 'Su cita con el Dr. García ha sido confirmada para el 15 de marzo a las 10:00 AM.',
