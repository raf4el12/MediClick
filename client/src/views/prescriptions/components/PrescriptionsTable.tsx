...
interface PrescriptionsTableProps {
  ...
  setPagination: React.Dispatch<React.SetStateAction<PrescriptionsTableProps['pagination']>>;
          ...
          <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
            ...
            <FormControl size="small" sx={{ minWidth: 140 }}>
              <Select
                ...
                onChange={(e) =>
                  updateFilters({ status: (e.target.value as AppointmentStatus) || undefined })
                }
                displayEmpty
              >
