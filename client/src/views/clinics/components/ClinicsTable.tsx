...
interface ClinicsTableProps {
  ...
  setPagination: React.Dispatch<React.SetStateAction<ClinicsTableProps['pagination']>>;
  debouncedSearch: (value: string) => void;
  drawerOpen: boolean;
  drawerData: { data: Clinic | null; action: 'Create' | 'Update' };
  openCreateDrawer: () => void;
  openEditDrawer: (clinic: Clinic) => void;
  closeDrawer: () => void;
...
export const ClinicsTable = memo(function ClinicsTable({
  data,
  loading,
  error,
  pagination,
      ...
      columnHelper.accessor('name', {
        ...
        cell: ({ row }) => (
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
            <i className="ri-building-line" style={{ fontSize: 20 }} />
      ...
      columnHelper.accessor('currency', {
        ...
        cell: ({ row }) => (
          <Box sx={{ display: 'flex', justifyContent: 'center' }}>
            <Chip label={row.original.currency} size="small" variant="outlined" />
          </Box>
        ),
      }),
              ...
              <TableBody>
                {loading ? (
                  ...
                  <TableRow>
                    ...
                    >
                      <i className="ri-building-line" style={{ fontSize: 48, display: 'block', marginBottom: 8 }} />
